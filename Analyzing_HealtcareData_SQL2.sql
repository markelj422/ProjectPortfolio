...
--Won't work because of drop constraint

Alter Table testTable
Drop Constraint DF__TestTable__Charg__75A278F5
--Constraint copy/pasted from Constraint folder <--
...
Into TestTable3
From TestTable
Where PatientState in ('GA','FL','WY','UT','CA')
Group By Gender 
